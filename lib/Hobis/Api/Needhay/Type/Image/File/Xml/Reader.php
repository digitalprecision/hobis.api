...
class Hobis_Api_Needhay_Type_Image_File_Xml_Reader extends Hobis_Api_Needhay_Type_Image_File_Xml
{
    /**
    ...
    {
        $domCollections = $dom->getElementsByTagName(Hobis_Api_Needhay_Needle_Collection::TYPE_IMAGE);
        ...
        foreach ($domCollections as $domCollection) {
            ...
            foreach ($domCollection->getElementsByTagName(Hobis_Api_Needhay_Store_Op_File_Xml::TAG_POINTER) as $domPointer) {
                ...
                $pointer->setSizeCode($domPointer->getElementsByTagName(parent::TAG_SIZE_CODE)->item(0)->nodeValue);
